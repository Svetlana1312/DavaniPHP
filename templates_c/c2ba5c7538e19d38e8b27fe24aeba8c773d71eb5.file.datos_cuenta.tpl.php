<?php /* Smarty version Smarty-3.1.21, created on 2015-12-01 18:50:48
         compiled from "C:\wamp\www\davani_old\templates\davani\components\datos_cuenta.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29944565dddf884a9a7-74023040%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2ba5c7538e19d38e8b27fe24aeba8c773d71eb5' => 
    array (
      0 => 'C:\\wamp\\www\\davani_old\\templates\\davani\\components\\datos_cuenta.tpl',
      1 => 1448973825,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29944565dddf884a9a7-74023040',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565dddf8971d59_88193827',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565dddf8971d59_88193827')) {function content_565dddf8971d59_88193827($_smarty_tpl) {?><div class="col-xs-12">
...
/guardar',$('#form-mod').serialize(),'POST',false,false)">
...
" required="true"  />
                    ...
                    <input type="text" class="form-control" name="nombre_completo" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_USUARIO']->value['nombre_completo'];?>
" required="true" />
...
" />
      ...
      <div role="tabpanel" class="tab-pane" id="facturacion">
          <form id="datos_facturacion" action="javascript:enviarDatosAjax('<?php echo $_smarty_tpl->tpl_vars['URL_ACTUAL']->value;?>
/guardar-fact',$('#datos_facturacion').serialize(),'POST',false,false)">
...
" />
                 <div class="col-xs-12 col-sm-2">
                  ...
                  <select name="title" class="form-control" >
                     <?php if ($_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['title']=='Sr') {?>
              ...
              <div class="col-xs-12 col-sm-6">
                  ...
                  <input type="text" class="form-control" name="nombre" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['name'];?>
" required="true" />

                  <label for="">Apellidos <b class="text-danger">*</b></label>
                  <input type="text" class="form-control" name="apellidos" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['middle_name'];?>
" required="true" />
                  <label for="">Companìa <b class="text-danger">*</b></label>
                  <input type="text" class="form-control" name="company" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['company'];?>
" required="true" />
                  <label for="">CIF/DNI/NIE <b class="text-danger">*</b></label>
                  <input type="text" class="form-control" name="cif" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['NIFDNINIE'];?>
" required="true" />
                  <label for="">Paìs <b class="text-danger">*</b></label>
                  <select name="pais" class="form-control" id="pais_f" onchange="enviarDatosAjax('<?php echo $_smarty_tpl->tpl_vars['URL_ACTUAL']->value;?>
/get_provincias',{id:$(this).val()},'POST','#select_provincias_f',false)" required="true" >
...
?>
                    <?php if ($_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['virtuemart_country_id']==$_smarty_tpl->tpl_vars['item']->value['id']) {?>
...
"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
                ...
                <?php } ?>
                  ...
                  <!--  <label for="">Ciudad </label>
                    ...
                    <input type="text" class="form-control" name="ciudad" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['city'];?>
" required="true" />
                  <label for="">CP  <b class="text-danger">*</b> </label>
                  <input type="text" class="form-control" name="cp" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['zip'];?>
" required="true" />
                  <label for="">Direcciòn de facturación  <b class="text-danger">*</b></label>
                  <input type="text" class="form-control" name="direccion" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['address_1'];?>
" required="true" />
                  <label for="">Telèfono  <b class="text-danger">*</b></label>
                  <input type="text" class="form-control" name="telefono" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['phone_1'];?>
" required="true" />
                  <label for="">Fax</label>
                  <input type="text" class="form-control" name="fax" value="<?php echo $_smarty_tpl->tpl_vars['DATOS_FACTURACION']->value['fax'];?>
"  />
                  <p class="text-center ">
    ...
    <div role="tabpanel" class="tab-pane" id="envio">
         <div id="form_dir_env" class="col-xs-12 col-sm-12">
                 ...
                 <div class="col-xs-12 col-sm-12">
                         ...
                         <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['DATOS_ENVIO']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
                             <div  class="col-xs-12 col-sm-6">
                                 <div class="offer offer-info">
                                     <div class="shape" >
                                         <div  class="shape-text" onclick="javascript:enviarDatosAjax('<?php echo $_smarty_tpl->tpl_vars['URL_ACTUAL']->value;?>
/delete-dir',{id:<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
},'POST','#form_dir_env',false)">
                                             X
                                         </div>
                                     </div>
                                     <div class="offer-content" onclick="javascript:enviarDatosAjax('<?php echo $_smarty_tpl->tpl_vars['URL_ACTUAL']->value;?>
/update-dir',{id:<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
},'POST','#form_dir_env',false)">
...
, <?php echo $_smarty_tpl->tpl_vars['item']->value['provincia'];?>
, <?php echo $_smarty_tpl->tpl_vars['item']->value['pais'];?>
          ...
          <div class="col-xs-12 col-sm-6" id="insert_div">
              <button class="btn btn-warning"
                      onclick="javascript:enviarDatosAjax('<?php echo $_smarty_tpl->tpl_vars['URL_ACTUAL']->value;?>
/insert-dir',{},'POST','#form_dir_env',false)" >Nueva direccion de envio
              </button>
           </div>
         </div>
    </div>

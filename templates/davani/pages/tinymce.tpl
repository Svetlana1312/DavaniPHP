...
<html lang="es">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1">
                <title>{$DATOS_PAGINA.titulo}</title>
                <meta name="description" content="{$DATOS_PAGINA.descripcion}" />
                <meta name="keywords" content="{$DATOS_PAGINA.keywords}" />
                <script>
                    var ABSOLUTE_URL='{$ABSOLUTE_URL}';
                </script>
		{include file='../blocks/links_top.tpl'}
	</head>
	<body>
            <div class="col-xs-12">
...
<div  class="modal fade" id="modal-explorer">
    <div class="modal-dialog">
        ...
        {include file='../blocks/links_bottom.tpl'}
	</body>
</html>